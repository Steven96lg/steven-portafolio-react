    ...
    return(
        <div id="info-component">
            ...
            <div className="links-component">
                ...
                <a href="https://www.github.com/Steven96lg"><i className="fas fa-link"></i> GitHub <i className="fa-brands fa-github"></i></a>
                <button className="contact-btn">Contactame <i className="fas fa-paper-plane"></i></button>
            </div>
